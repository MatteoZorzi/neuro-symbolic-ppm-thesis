"""Kill test — scala di ablazione a tre gradini sul marking della Petri net.
...
Lettura: delta(2-1) ~0 gia' noto (rumore, 14 lug); la domanda nuova e'
delta(3-2): se la GNN batte il piatto, il merito e' della struttura.
"""
